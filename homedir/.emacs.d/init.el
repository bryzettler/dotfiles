...
(use-package counsel
  ...
  :config
  (setq ivy-initial-inputs-alist nil)) ;; Don't start searchers with ^
...
(use-package general
  ...
  (general-create-definer zyrb/leader-keys
    :keymaps '(normal inster visual emacs)
    :prefix "SPC"
    :global-prefix "C-SPC")
