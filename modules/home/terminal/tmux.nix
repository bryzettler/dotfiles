...
in
{
  programs.tmux = {
    ...
    extraConfig = ''
      # True color (24-bit) + styled/colored underline support
      ...
      set -ag terminal-overrides ",tmux-256color:Smulx=\E[4::%p1%dm"
      ...
      set -ag terminal-overrides ",tmux-256color:Setulc=\E[58::2::%p1%{65536}%/%d::%p1%{256}%/%{255}%&%d::%p1%{255}%&%d%;m"
